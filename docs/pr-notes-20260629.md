...
| # | 改动 | 截图 |
|---|---|---|
| 1 | `assets/demos/miaohui-workbench.html` / `assets/demos/miaohui-workbench-mobile.html`：桌面 / 移动 demo 均改为远程 Tailwind CDN，桌面保留内联样式以维持现有布局 | ✅ |
...
- 桌面 demo `assets/demos/miaohui-workbench.html` 已移除本地 `miaohui-workbench.css` 外链，改为 `https://cdn.tailwindcss.com`，并将原桌面样式内联到 HTML 中。
- 移动 demo `assets/demos/miaohui-workbench-mobile.html` 继续保持 `https://cdn.tailwindcss.com` 远程引用。
