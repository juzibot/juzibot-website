...
(function () {
  ...
  var ROUTES = [
    ...
    { re: /(接入|上线|多久|部署|开通|落地|实施)/i, a: '标准 IM 渠道（微信/企业微信/抖音/飞书等）最快 1 天就能让第一个 AI 员工上岗；复杂业务由 FDE 团队陪跑约 90 天达成结果指标。', cards: ['fde', 'miaohui'] },
    ...
    { re: /(渠道|微信|抖音|飞书|小红书|whatsapp|平台|通道)/i, a: '微信、企业微信、抖音、小红书、飞书、WhatsApp 等 10+ 主流 IM，全部收进一个工作台统一接待。', cards: ['miaohui'] },
