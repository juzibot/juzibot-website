...
(function () {
  ...
  var ENT = {
    ...
    dongxing: { nm: '句子懂行 · 记忆', ds: '把资料沉淀成 AI 可用的组织记忆', ic: 'fa-book-bookmark', href: P('dongxing.html') },
  ...
  var ROUTES = [
    ...
    { re: /(知识|文档|资料|检索|出处|知识库)/i, a: '句子懂行是 AI 员工的记忆：归档 Agent 接住原始资料并拆成知识单元，体检 Agent 持续找冲突、缺口和过期内容，检索 Agent 按指定范围带出处回答。', cards: ['dongxing'] },
